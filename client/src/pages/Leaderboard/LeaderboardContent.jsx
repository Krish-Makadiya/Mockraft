...
const LeaderboardContent = () => {
    ...
    return (
        <div className="mx-auto h-screen">
            {/* Header Card */}
            <div className="flex items-center gap-6 bg-light-surface dark:bg-dark-bg rounded-2xl p-6 shadow-xl mb-8">
                ...
                <div>
                    ...
                    <p className="text-gray-500 dark:text-gray-300 mt-2 ">
                        Find all the results and scores of your friends and the
                        whole community. <br /> Your turn! Become the first!
                    </p>
                </div>
            </div>
            ...
            {currentUserRank && (
                <div className="mb-4">
                    <li
                        className={`relative grid grid-cols-6 items-center text-center py-4 mx-auto transition-all duration-300
                        ...
                        <div className="flex justify-center items-center gap-3">
                            {currentUserRank.avtaar ? (
                                <img
                                    ...
                                    className="w-10 h-10 rounded-full border-2 border-blue-400 dark:border-blue-600 object-cover shadow"
                                />
                            ) : (
            ...
            <div className="bg-light-surface dark:bg-dark-bg rounded-2xl shadow-lg overflow-hidden">
                <div className="grid grid-cols-6 text-center text-gray-500 dark:text-gray-400 w-full py-3 text-sm font-semibold">
                    <span>Rank</span>
                    <span>Name</span>
                    <span>Points</span>
                    <span>Tier</span>
                ...
                <ul>
                    {top10.map((user, idx) => (
                        <li
                            key={user.id}
                            className={`grid grid-cols-6 items-center text-center py-4 transition-all duration-300 ${
                                idx < 3
                            ...
                            <div className="flex justify-center items-center gap-3">
                                {user.avtaar ? (
                                    <img
                                        src={user.avtaar}
                                        alt={user.fullname}
                                        className={`w-9 h-9 rounded-full border-2 border-gray-300 dark:border-gray-700 object-cover ${
                                            idx < 3 ? "scale-110" : ""
                                        }`}
                                    />
                                ) : (
